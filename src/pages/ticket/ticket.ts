...
export class TicketPage {
 ...
 doRefresh(refresher) {
    ...
    this.ticketsService.getAsignatePost(  200 , 0 , false).subscribe(response => {
...
reinitialiser(){
 ...
 goToAddPage() {
  ...
  getPosts( limit){
   this.ticketsService.getAsignatePost( limit , 0 , false).subscribe(response => {
      this.tickets = response;
  ...
  getClosedPost(limit){
    this.ticketsService.getAsignatePost( 10 , this.offset , true).subscribe(response => {
...
// this.ticketsService.getAsignatePost(  limit , offset).subscribe
