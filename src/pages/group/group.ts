...
export class GroupPage {
 ...
 doRefresh(refresher) {
    ...
    this.ticketsService.getGroupeTickets(200 , 0 , false).subscribe(response => {
...
reinitialiser(){
 ...
 goToAddPage() {
  ...
  getPosts( limit){
   this.ticketsService.getGroupeTickets( limit , 0 , false).subscribe(response => {
      this.tickets = response;
  ...
  getClosedPost(limit){
    this.ticketsService.getGroupeTickets( 10 , this.offset , true).subscribe(response => {
